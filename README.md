...
````
bash <(curl -Ls https://raw.githubusercontent.com/goodman850/easy-installer/master/install.sh --ipv4)
````
...
````
bash <(curl -Ls https://raw.githubusercontent.com/goodman850/easy-installer/master/ssl.sh --ipv4)
````
